...
export default function FOS(m, N, N2, F, rpm, torque, pr, elasticModulus, hardness, Q, Ko, process, material, grade) {
...
export function worst_case_loading(torque, power) {
    var avg_rpm = (power / torque) * (30 / Math.PI);
    return [torque, avg_rpm]
}

// var a = geometryFactor(41, 83);
// console.log(a);
// console.log(1);